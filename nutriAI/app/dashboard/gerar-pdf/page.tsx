      ...
      <motion.div variants={fadeInUp} className="flex flex-col gap-3">
        {!pdfGenerated ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <Button size="lg" variant="outline" className="h-14 gap-2 border-blue-200" onClick={() => window.location.href = `mailto:?subject=Plano alimentar ${patientData.name}&body=Segue o plano alimentar gerado no NutriAI.`}>
